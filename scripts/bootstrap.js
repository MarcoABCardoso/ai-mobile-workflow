...
file('mobile/package.json', json({
  ...
  scripts: { start: 'expo start', android: 'expo run:android', ios: 'expo run:ios', web: 'expo start --web', test: 'jest' },
...
file('mobile/app.json', json({
  expo: { name: P, slug: P, version: '1.0.0', orientation: 'portrait', platforms: ['ios', 'android', 'web'], scheme: P },
}))
